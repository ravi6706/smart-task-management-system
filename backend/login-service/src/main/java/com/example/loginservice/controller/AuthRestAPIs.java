...
import com.example.loginservice.message.request.LoginForm;
import com.example.loginservice.message.request.SignUpForm;
import com.example.loginservice.message.response.JwtResponse;
import com.example.loginservice.message.response.ResponseMessage;
import com.example.loginservice.model.Role;
import com.example.loginservice.model.RoleName;
import com.example.loginservice.model.SignupMail;
...
import com.example.loginservice.service.MailSenderService;
...
public class AuthRestAPIs {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) throws MessagingException {
        ...
        String content = "<html>" +
                "<body>" +
                "<p>Hello "+name+",</p>" +
                "<p>You have been successfully registered on <strong>SMART TASK</strong> portal!</p>" +
